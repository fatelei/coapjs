...
var toContentFormatNum = require('./utils/convert').toContentFormatNum;
...
Response.prototype.setHeader = function(key, value) {
  ...
  if (key === "Content-Format") {
    value = toContentFormatNum(value);
  }
...
Response.prototype.end = function(code, payload) {
  ...
  if (self.accept !== null) {
    var formatNumber = toContentFormatNum(self.accept);
  ...
  if (body === null) {
    ...
    if (typeof body === 'object') {
      ...
      self.packet.payload = new Buffer(body.toString());
    }
  }
